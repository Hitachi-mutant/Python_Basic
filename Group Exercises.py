...
# # Task 8 - On-line store statistics: Now let's break something and find errors:

# # продукти ваші клієнти купують найчастіше
# awesome_CPUs_store_list = [1,2,3,4,5]
# def most_popular_product(cpu_store):
#     # sold_values = []
#     # for product in cpu_store:
#     #     sold_values.append(cpu_store[product]['Sold'])
...
# most_popular_product(awesome_CPUs_store_list)

# # продукти ваші клієнти купують найрідше
# awesome_CPUs_store_min = {
#     'INTEL Core i5 11400F' : {'Price, $' : 499, 'Stock' : 34, 'Sold' : [],},
#     'INTEL Pentium G6405' : {'Price, $' : 537, 'Stock' : 21, 'Sold' : '%',},
#     'AMD Ryzen 5 3600' : {'Price, $' : 318, 'Stock' : 42, 'Sold' : '(',},
#     'AMD Ryzen 7 5700X' : {'Price, $' : 819, 'Stock' : 51, 'Sold' : 'y',},
#     }
...
#         return min(product['Sold'] for product in cpu_store.values())
#     except TypeError:
#         print('Do not enter some dumb input')

# most_unpopular_product(awesome_CPUs_store_min)

# # Скільки разів клієнти купували кожен з ваших продуктів
# awesome_CPUs_store_total_sales = {
#     'INTEL Core i5 11400F' : {'Price, $' : 499, 'Stock' : 34, 'Sold' : ')',},
#     'INTEL Pentium G6405' : {'Price, $' : 537, 'Stock' : 21, 'Sold' : 4,},
#     'AMD Ryzen 5 3600' : {'Price, $' : 318, 'Stock' : 42, 'Sold' : 5,},
#     'AMD Ryzen 7 5700X' : {'Price, $' : 819, 'Stock' : 51, 'Sold' : 6,},
#     }
...
#         all_product_sales = {}
#         for item, product in cpu_store.items():
#             all_product_sales[product['Stock']] == product['Sold']

#         return all_product_sales
#     except KeyError:
#         print('Write your code properly!')
#     finally:
#         print("You've got your KeyError")

# total_sales(awesome_CPUs_store_total_sales)
...
# file_to_open = open('file_with_things.txt', 'w+')

# # Записуємо декілька рядків тексту у файл
# important_data = str([1,2,3,4,5,6,7])
# file_to_open.write(important_data)

# file_to_open.seek(0)
# print_file_to_open = file_to_open.read()
# print(print_file_to_open)
...
# with open("new_file_with_list.txt", "w+") as file_with_list:
#     line_count = 0
#     for line in lines:
#         result = (file_with_list.write(line + ' : ' + str(lines[line]) + "\n") )
#         line_count += 1

# with open("new_file_with_list.txt", "r") as file_with_list:
#     contents = file_with_list.read()
...
# # Умовно, у вас є в дікті значення country : capital - видаліть цей запис
...
# file_path = "web_development_int.json"

# with open(file_path, "w+") as our_json_file:
#     json.dump(web_development_int, our_json_file)
...
# employees_list = json_data.get("employees", [])
# filtered_employees = [employee for employee in employees_list if employee.get("id") != 2]
# json_data["employees"] = filtered_employees
