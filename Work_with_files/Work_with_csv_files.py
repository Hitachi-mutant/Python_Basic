...
json_header = list_from_csv_file[0]
json_data = list_from_csv_file[1:]

turn_list_to_dict = [dict(zip(json_header, row)) for row in json_data]
print(turn_list_to_dict)
with open('Work_with_files/input_to_json_nestle_employee.json', 'w', newline='') as file:
